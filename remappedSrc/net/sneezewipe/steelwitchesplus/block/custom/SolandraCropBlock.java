...
public class SolandraCropBlock extends CropBlock {
    ...
    public SolandraCropBlock(Settings settings) {
        super(settings.mapColor(MapColor.YELLOW).nonOpaque().noCollision().ticksRandomly().breakInstantly().sounds(BlockSoundGroup.CROP).pistonBehavior(PistonBehavior.DESTROY));
    }
